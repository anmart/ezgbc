; Graciously aped from bootstrap.gb from http://nocash.emubase.de/pandocs.htm
...
; Button/Direction Key Constants
KEY_DOWN	EQU %10000000
KEY_UP		EQU %01000000
KEY_LEFT	EQU %00100000
KEY_RIGHT	EQU %00010000
KEY_START	EQU %00001000
KEY_SELECT	EQU %00000100
KEY_B		EQU %00000010
KEY_A		EQU %00000001
