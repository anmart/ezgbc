; This hardware.inc has been modified
; For a complete version of hardware.inc, visit
...
vBGMap0         EQU $9800
vBGMap1         EQU $9c00
vTileDataSize   EQU $10


; *** MBC5 Equates ***

rMBC5_SRAM       EQU $0000 ; $0000->$1fff
rMBC5_BANK       EQU $2000 ; $2000->$2fff
rMBC5_BANK_H     EQU $3000 ; $3000->$3fff - If more than 256 ROM banks are present.
rMBC5_SRAM_BANK  EQU $4000 ; $4000->$5fff - Bit 3 enables rumble (if present)
